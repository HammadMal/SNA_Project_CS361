...
# Output directory
output_dir <- file.path(resultpath, "network_metrics_visualizations-part_party")
...
cat("TOP 10 TABLE (11) CONTAINS:\n")
cat("  • Visual table showing top 10 parties for 5 centrality measures\n")
...
cat("✓ Includes comprehensive top 10 rankings for all centrality measures\n\n")
